          ...
          success: function (res) {
            ...
            if(res.data.length){
              $.each(res.data, function(key,val) {
                if(type=='sent'){
                  e = e + '<div id="'+type+'_'+val.id+'" class="mb-2 d-flex justify-content-between"><table class="ms-1"><td class="align-middle">'+val.receiver[0].name+'</td><td class="align-middle"> - </td><td class="align-middle">'+val.receiver[0].email+'</td><td class="align-middle"></div> </table><div><button id="cancel_request_btn_" class="btn btn-danger me-1" onclick=withdrawRequest('+val.id+')>Withdraw Request</button></div></div>';
                }
                if(type=='received'){
                  e = e + '<div class="mb-2 d-flex justify-content-between"><table class="ms-1"><td class="align-middle">'+val.name+'</td><td class="align-middle"> - </td><td class="align-middle">'+val.email+'</td><td class="align-middle"></div> </table><div><button id="accept_request_btn_" class="btn btn-primary me-1" onclick="">Accept</button></div></div>';
                }
                if(type=='suggestions'){
                  e = e + '<div class="mb-2 d-flex justify-content-between"><table class="ms-1"><td class="align-middle">'+val.name+'</td><td class="align-middle"> - </td><td class="align-middle">'+val.email+'</td><td class="align-middle"></div> </table><div><button onclick=handleAction('+val.id+') id="create_request_btn_" class="btn btn-primary me-1">Connect</button></div></div>';
                }
                if(type=='connections'){
                  ...
                  if(user_id != val.sender[0].id){
                    e = e + '<div class="mb-2 d-flex justify-content-between"><table class="ms-1"><td class="align-middle">'+val.sender[0].name+'</td><td class="align-middle"> - </td><td class="align-middle">'+val.sender[0].email+'</td><td class="align-middle"></div> </table><div><div><button style="width: 220px" id="get_connections_in_common_" class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_" aria-expanded="false" aria-controls="collapseExample">Connections in common ('+val.commonConnections.data.length+')</button> <button id="create_request_btn_" onclick=withdrawRequest('+val.id+',"connection") class="btn btn-danger me-1">Remove Connection</button></div></div></div>';
                  }else{
                    e = e + '<div class="mb-2 d-flex justify-content-between"><table class="ms-1"><td class="align-middle">'+val.receiver[0].name+'</td><td class="align-middle"> - </td><td class="align-middle">'+val.receiver[0].email+'</td><td class="align-middle"></div> </table><div><div><button style="width: 220px" id="get_connections_in_common_" class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_" aria-expanded="false" aria-controls="collapseExample">Connections in common ('+val.commonConnections.data.length+')</button> <button id="create_request_btn_" onclick=withdrawRequest('+val.id+',"connection") class="btn btn-danger me-1">Remove Connection</button></div></div></div>';
                  }
                }
            });
            }
